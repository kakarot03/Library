...
public class SPCredentials {
    private static String publicKeyFile = "C:\\apache-tomcat-9.0.67\\webapps\\Library\\certificates\\spPublic.pem";
    private static String privateKeyFile = "C:\\apache-tomcat-9.0.67\\webapps\\Library\\certificates\\spPrivate.der";
    private static String IDPPublicKeyFile = "C:\\apache-tomcat-9.0.67\\webapps\\Library\\certificates\\idpPublic.pem";
    ...
    public static Credential getIDPublicKeyCredential() throws Exception {
        return CredentialSupport.getSimpleCredential(getPublicKey(IDPPublicKeyFile), null);
    }
