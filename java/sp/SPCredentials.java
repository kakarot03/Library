...
public class SPCredentials {
    private static final String KEY_STORE_PASSWORD = "wso2carbon";
    private static final String KEY_STORE_ENTRY_PASSWORD = "wso2carbon";
    private static final String KEY_STORE_PATH = "/wso2carbon.jks";
    private static final String KEY_ENTRY_ID = "wso2carbon";
