...
public class UserLogin extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) {
		try {
			...
			stmt.execute(
					"CREATE TABLE IF NOT EXISTS users (id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(255) UNIQUE, password VARCHAR(255) NOT NULL)");
			...
			String query3 = " CREATE TABLE IF NOT EXISTS dropbox (id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(255) UNIQUE, access_token VARCHAR(255) NOT NULL)";
			String query4 = "ALTER TABLE books AUTO_INCREMENT = 1101";
			String query5 = "ALTER TABLE orders AUTO_INCREMENT = 611";
			stmt.addBatch(q1);
			stmt.addBatch(q2);
