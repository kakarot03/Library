...
<%
	...
	if(status != null && status.equals("success")) {
		...
		<div id="successMsg" style="display: block; margin-left: 42%; margin-top: 6%"><font color="green" size="4">File Deleted Successfully</font><br/>
		<%
		...
		<div style="margin-left: 39.3%; margin-top: 1%">
			<font color="red" size="3">Try adding '/' before the Destionation path</font>
		</div>
		<%
	}
%>
...
<div class="container"
		...
		<h1 style="margin-left: 8%;">Delete File</h1>
		<form action="http://localhost:8080/Library/dropBox/manage" method="post" style="display: flex; flex-direction: column; justify-content: center; margin-top: 2%; margin-left: 5.5%;">
			<div class="form-group">
				...
				<input required="required" class="form-control w-25" name="path" placeholder="Path of the file in DropBox">
			</div>
			<div style="display: none">
				<input name="action" value="2">
			</div>
            <button type="submit" class="btn btn-primary" style="margin-top: 2%; width: 13%; margin-left: 6%;">Delete</button>
		</form>
</div>
<script>
