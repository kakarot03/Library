...
<body>
	...
	<form action="http://localhost:8080/Library/webapp/OperationManager.jsp" method="post"	style="margin-top: 13%; margin-left: 42%;">
		<% 
		   ...
		   if (msg !=null && msg.equals("success")) { %>
			<div style="margin-bottom: 3%">	
				<font color="green" size="4">Book Exported Successfully</font>	
			</div>
		...
		<% } %>	
		<h1 style="margin-left: -1%;">Export Books</h1>				
		...
		<div class="input-group w-25">	
			<select class="custom-select" id="bookProp" name="bookProp">
				<option value="1">Export All Books</option>
				<option value="2">Export Specific Book</option>				
			</select>
		</div>
		...
		<button type="submit" class="btn btn-primary col-xs-1" style="margin-top: 3%; margin-left: 5%; width: 15%">Export</button>
		<div style="display: none">
			<input name="operation" value="5">				
		</div>
	</form>
<script>	
